...
I1x_doub_comm = (kron(I1x,E)-kron(E,transpose(I1x)))^2;
I1y_doub_comm = (kron(I1y,E)-kron(E,transpose(I1y)))^2;
I1z_doub_comm = (kron(I1z,E)-kron(E,transpose(I1z)))^2;

I2x_doub_comm = (kron(I2x,E)-kron(E,transpose(I2x)))^2;
I2y_doub_comm = (kron(I2y,E)-kron(E,transpose(I2y)))^2;
I2z_doub_comm = (kron(I2z,E)-kron(E,transpose(I2z)))^2;
