...
Ix_doub_comm = (kron(Ix,E)-kron(E,transpose(Ix)))^2;
Iy_doub_comm = (kron(Iy,E)-kron(E,transpose(Iy)))^2;
Iz_doub_comm = (kron(Iz,E)-kron(E,transpose(Iz)))^2;
...
plot(t*1e3,exp(-t/T2),'k');
% plot(t*1e3,1-exp(-t/T1),'--k');
